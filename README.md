...
![](http://upload-images.jianshu.io/upload_images/2701853-8db4559c6dec5adb.gif?imageMogr2/auto-orient/strip)
...
> * less
***
[git地址](https://github.com/ToNiQian/vue-spa-example)
...
定义好模块名称,建议**pages**,**images**,**routes**目录,模块名保持一致,
